...
or                                               //或
(XMIN is commited and (XMAX == NULL or (XMAX != Ti and XMAX is not commited)))
...
```
(XMIN == Ti and (XMAX == NULL))                           //由Ti创建且尚未被删除
or                                                        //或
(XMIN is commited and)                                    //由一个已提交的事务创建且
 ...
 (XMAX == NULL or )                                       //尚未被删除或
   (XMAX != Ti and)                                       //由其他事务删除但是
     (XMAX id not commited or                             //这个事务尚未提交或
 XMAX > Ti or                                             //这个事务在Ti开始之后才开始或
XMAX id in SP(Ti)                                         //这个事务在Ti开始前还未提交
))))
```
